...
Route::get('register/add-information', 'Auth\RegisterInfoController@showForm');
Route::post('register/add-information', 'Auth\RegisterInfoController@postForm')->name('addinformation');
