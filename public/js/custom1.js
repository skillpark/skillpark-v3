...
$(document).ready(function() {
    $('#list').click(function(event) {
        ...
        $('#products .lg-item').addClass('list-group-item1');
    });
    $('#grid').click(function(event) {
        event.preventDefault();
        $('#products .lg-item').removeClass('list-group-item1');
        $('#products .lg-item').addClass('grid-group-item1');
    });
});
...
$(document).ready(function() {
    $('#list').click(function(event) {
        event.preventDefault();
        $('#products_1 .lg-item').addClass('list-group-item1');
    });
    $('#grid').click(function(event) {
        event.preventDefault();
        $('#products_1 .lg-item').removeClass('list-group-item1');
        $('#products_1 .lg-item').addClass('grid-group-item1');
    });
});
...
$(document).ready(function() {
    $('#list').click(function(event) {
        event.preventDefault();
        $('#products_2 .lg-item').addClass('list-group-item1');
    });
    $('#grid').click(function(event) {
        event.preventDefault();
        $('#products_2 .lg-item').removeClass('list-group-item1');
        $('#products_2 .lg-item').addClass('grid-group-item1');
    });
});