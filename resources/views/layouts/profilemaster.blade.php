...
<head>
    <title>User Profile - Skillpark</title>
                    ...
                    <div class="right-side">
                        ...
                        <div class="header-widget">
                            ...
                            <div class="header-notifications user-menu">
                                <div class="header-notifications-trigger">
                                    <a href="#">
                                        <div class="user-avatar status-online"><img alt="{{Auth::user()->name}}"
                                                src="{{ auth()->user()->avatar }}"></div>
                                    </a>
                                </div>
                                ...
                                <div class="header-notifications-dropdown" style="width: 350px;">
                                    ...
                                    <ul class="user-menu-small-nav" style="font-size: 18px;">
                                        <li style="margin-bottom: 5px;"><a href="{{ url('dashboard')}}"><i
                                                    class="icon-material-outline-dashboard"></i> Dashboard</a></li>
                                        <li style="margin-bottom: 5px;"><a href="{{ url('settings')}}"><i
                            ...
                            <div class="dashboard-nav-inner">
                                ...
                                <ul data-submenu-title="Start">
                                    <li class="{{ (request()->is('home*')) ? 'active' : '' }}"><a
                                            href="{{ url('home') }}"><i class="icon-material-outline-home"></i> My
                                            Feed</a></li>
                                    <li class="{{ (request()->is('recommended*')) ? 'active' : '' }}"><a
                                            href="{{ url('home') }}"><i
                                                class="icon-material-outline-question-answer"></i> Recommended <span
                                                class="nav-tag">6</span></a></li>
                                </ul>

                                <ul data-submenu-title="Organize and Manage">
                                    <li class="{{ (request()->is('task*')) ? 'active' : '' }}"><a href="#"><i
                                                class="icon-material-outline-assignment"></i> Tasks</a>
                                        <ul>
                                ...
                                <ul data-submenu-title="Account">
                                    ...
                                    <li class="{{ (request()->is('settings*')) ? 'active' : '' }}"><a
                                            href="{{ url('settings') }}"><i class="icon-material-outline-settings"></i>
                                            Settings</a></li>
